...
{
    public class ManagerAddMemeberController : Controller
    {
        private ApplicationDbContext dbContext;

        public ManagerAddMemeberController(ApplicationDbContext dbContext)
        {
        ...
        public async Task<IActionResult> Add(AddMemberViewModel memberData)
        {
