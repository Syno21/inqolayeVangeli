    ...
    public partial class InitialCreates : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MembershipStatuses", x => x.StatusID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Activity_Branches_BranchID",
                        column: x => x.BranchID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivityHistory", x => x.ActivityID);
                    table.ForeignKey(
                        name: "FK_ActivityHistory_Members_MemberID",
                        column: x => x.MemberID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Demographics_Members_MemberID",
                        column: x => x.MemberID,
                        principalTable: "Members",
                        principalColumn: "MemberID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberStatusHistory", x => x.StatusHistoryID);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MemberStatusHistory_MembershipStatuses_StatusID",
                        column: x => x.StatusID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityHistory_MemberID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberStatusHistory_StatusID",
                table: "MemberStatusHistory",
                column: "StatusID");
